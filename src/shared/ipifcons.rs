...
pub const MIB_IF_OPER_STATUS_NON_OPERATIONAL: INTERNAL_IF_OPER_STATUS =
    INTERNAL_IF_OPER_STATUS::IF_OPER_STATUS_NON_OPERATIONAL;
pub const MIB_IF_OPER_STATUS_UNREACHABLE: INTERNAL_IF_OPER_STATUS =
    INTERNAL_IF_OPER_STATUS::IF_OPER_STATUS_UNREACHABLE;
pub const MIB_IF_OPER_STATUS_DISCONNECTED: INTERNAL_IF_OPER_STATUS =
    INTERNAL_IF_OPER_STATUS::IF_OPER_STATUS_DISCONNECTED;
pub const MIB_IF_OPER_STATUS_CONNECTING: INTERNAL_IF_OPER_STATUS =
    INTERNAL_IF_OPER_STATUS::IF_OPER_STATUS_CONNECTING;
pub const MIB_IF_OPER_STATUS_CONNECTED: INTERNAL_IF_OPER_STATUS =
    INTERNAL_IF_OPER_STATUS::IF_OPER_STATUS_CONNECTED;
pub const MIB_IF_OPER_STATUS_OPERATIONAL: INTERNAL_IF_OPER_STATUS =
    INTERNAL_IF_OPER_STATUS::IF_OPER_STATUS_OPERATIONAL;
