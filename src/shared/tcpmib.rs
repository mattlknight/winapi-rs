...
//! Contains the public definitions and structures for the TCP-specific parts of MIB-II.
...
// pub type MIB_TCPROW = MIB_TCPROW_LH; // Windows Vista
...
// pub type MIB_TCPSTATS = MIB_TCPSTATS_LH; // Windows Vista
